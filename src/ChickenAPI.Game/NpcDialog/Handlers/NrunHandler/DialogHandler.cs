...
namespace ChickenAPI.Game.NpcDialog.Handlers
{
    public class DialogHandler
    {
        ...
        [NpcDialogHandler(1)]
        public static void ChangeJobMiMi(IPlayerEntity player, NpcDialogEventArgs args)
        {
            if (player.Character.Class != Enums.Game.Character.CharacterClassType.Adventurer)
            {
